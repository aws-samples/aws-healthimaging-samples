...
// handler: Lambda handler, i.e. index.handler
// codePath: path to the code, i.e. ./lambda/edge_signer
// inlinePolicy: an iam.PolicyStatement to attach to the Lambda execution policy
// additionalBuildCmds: additional bash build commands
