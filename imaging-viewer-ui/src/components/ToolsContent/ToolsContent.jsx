        ...
        case '/datastores':
            return (
                ...
                >
                    <div>
                        <p>
                            A data store provides logical separation of imaging data. This enables multi-tenant use
                            cases.
                        </p>
                        <p>
                            Datastores are assigned Amazon Resource Names (ARNs) and can be tagged with keys and values.
                            This enables fine-grained access controls across organizations using role-based access
                            control (RBAC) and/or attribute-based access control (ABAC). Tags can also be used for cost
                            allocation.
                        </p>
                    </div>
                </HelpPanel>
        ...
        case '/search':
            return (
                <HelpPanel header={<h2>ImageSet Search</h2>} footer={<Footer />}>
                    <div>
                        <p>
                            The Amazon HealthLake Imaging service provides native search functionality. You can search
                            in a datastore by the following parameters:
                        </p>
                        <ul>
                            <li>Patient ID</li>
                        ...
                        <p>
                            Alternatively, you can use an event-drive architecture to search based off of ImageSet
                            metadata JSON.
                        </p>
                    </div>
                </HelpPanel>
        ...
        case '/metadata':
            return (
                <HelpPanel header={<h2>ImageSet Metadata</h2>} footer={<Footer />}>
                    <div>
                        <p>
                            Amazon HealthLake Imaging provides an optimized JSON representation of an ImageSet's
                            metadata.
                        </p>
        ...
        case '/viewer':
            return (
                ...
                >
                    <div>
                        <p>
                            Amazon HealthLake Imaging stores and provides image frames in lossless High Throughput JPEG
                            2000 (HTJ2K) format. HTJ2K is a simple extension to the existing JPEG2000 standard that
                            replaces block coder resulting in an order of magnitude speedup.
                        </p>
                        <p>
                            This component uses{' '}
                        ...
                        <ExpandableSection header="Loading Methods">
                            ...
                            <p>
                                ...
                                Using webworkers, request each image frame and read it chunk by chunk. After each chunk
                                is read, append it to the previous chunks for a partial object. The partial objects are
                                decoded and displayed until the entire image frame is read.
                            </p>
                            <p>
                                <strong>Tile Level Markers: </strong>
                                Using webworkers, request each image frame start withing Tile Level Marker (TLM) level
                                0. This initial small object represents a discrete resolution representation of the
                                image frame, and is useful for specific workloads, such as thumbnails. This object is
                                decoded and displayed. Subsequent TLM levels are requested, appended to the initial
                                object, then decoded and displayed. This method requires a TLM proxy. Configure using
                                the settings icon by the Reset button.
                            </p>
                        </ExpandableSection>
                        <ExpandableSection header="Settings">
                            <strong>Tile Level Marker Proxy</strong>
                            <p>
                                This proxy can be deployed from the tile-level-marker-proxy project in the code
                                repository. Provide the full public URL in the settings and the authorization mode to
                                enable TLM loading.
                            </p>
