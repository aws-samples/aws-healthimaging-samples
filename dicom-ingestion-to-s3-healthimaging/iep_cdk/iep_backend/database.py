...
class AuroraServerlessDB(Construct):
    ...
    def __init__(self, scope: Construct, id: str, vpc: ec2.Vpc, db_name: str, aurora_security_group: ec2.SecurityGroup, min_acu_capacity: int, max_acu_capacity: int, **kwargs) -> None:
        ...
        self._subnetGroup = rds.SubnetGroup(self, "iep-Aurora-Subnet-Group", vpc=vpc, vpc_subnets=ec2.SubnetSelection(subnet_type=ec2.SubnetType.PRIVATE_WITH_EGRESS), description="ahi index Aurora DB Subnet Group")
        ...
        self._dbCluster = rds.DatabaseCluster(
            ...
            parameter_group=rds.ParameterGroup.from_parameter_group_name(self, "iep-db-cluster-ParameterGroup", parameter_group_name="default.aurora-mysql8.0"),
            cluster_identifier=stack_name+"-iep-db-cluster",
            ...
            serverless_v2_min_capacity=min_acu_capacity,
            serverless_v2_max_capacity=max_acu_capacity,
            vpc=vpc
        )
